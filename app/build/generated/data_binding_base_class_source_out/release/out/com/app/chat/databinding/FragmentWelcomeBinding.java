...
public final class FragmentWelcomeBinding implements ViewBinding {
  ...
  private FragmentWelcomeBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
      @NonNull Button btnRegister, @NonNull LinearLayout logoContainer,
  ...
  public static FragmentWelcomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentWelcomeBinding((ConstraintLayout) rootView, btnLogin, btnRegister,
          logoContainer, welcomeText);
    }
